...
class PlaceListEntity {
    ...
    factory PlaceListEntity.fromJson(String str) => PlaceListEntity.fromMap(json.decode(str));
    String toJson() => json.encode(toMap());

    factory PlaceListEntity.fromMap(Map<String, dynamic> json) => PlaceListEntity(
        placeList: json["placeList"] == null ? null : List<PlaceListDetailEntity>.from(json["placeList"].map((x) => PlaceListDetailEntity.fromMap(x))),
    );

    Map<String, dynamic> toMap() => {
        "placeList": placeList == null ? null : List<dynamic>.from(placeList!.map((x) => x.toMap())),
    };
}
...
class PlaceListDetailEntity {
    ...
    factory PlaceListDetailEntity.fromJson(String str) => PlaceListDetailEntity.fromMap(json.decode(str));

    String toJson() => json.encode(toMap());

    factory PlaceListDetailEntity.fromMap(Map<String, dynamic> json) => PlaceListDetailEntity(
        ...
        imgs: json["imgs"] == null ? null : List<String>.from(json["imgs"].map((x) => x)),
        ...
        ratingAverage: json["ratingAverage"] == null ? null : json["ratingAverage"].toDouble(),
        zipCode: json["zipCode"] == null ? null : json["zipCode"],
        status: json["status"] == null ? null : json["status"],
        isPopularThisWeek: json["isPopularThisWeek"] == null ? null : json["isPopularThisWeek"],
        isNovelty: json["isNovelty"] == null ? null : json["isNovelty"],
        hasFreeDelivery: json["hasFreeDelivery"] == null ? null : json["hasFreeDelivery"],
    ...
    Map<String, dynamic> toMap() => {
        ...
        "isPopularThisWeek": isPopularThisWeek == null ? null : isPopularThisWeek,
